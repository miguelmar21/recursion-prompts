...
// We iterate through the array by incremenets of one with each call.
// We then slice the first element in the array until array.length === 0.
...
// Cannot use % method
// To check if number is even, we can subtract two from the number
// once the number reaches 1 or 0, then we can determine if it is even.
